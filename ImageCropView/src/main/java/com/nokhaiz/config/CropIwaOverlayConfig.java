...
import com.nokhaiz.AspectRatio;
import com.nokhaiz.R;
import com.nokhaiz.shape.CropIwaOvalShape;
import com.nokhaiz.shape.CropIwaRectShape;
import com.nokhaiz.shape.CropIwaShape;
import com.nokhaiz.util.ResUtil;
...
public class CropIwaOverlayConfig {
    ...
    public static CropIwaOverlayConfig createDefault(Context context) {
        ...
        CropIwaOverlayConfig config = new CropIwaOverlayConfig()
                .setBorderColor(r.color(R.color.image_crop_view_default_border_color))
                .setCornerColor(r.color(R.color.image_crop_view_default_corner_color))
                .setGridColor(r.color(R.color.image_crop_view_default_grid_color))
                .setOverlayColor(r.color(R.color.image_crop_view_default_overlay_color))
                .setBorderStrokeWidth(r.dimen(R.dimen.image_crop_view_default_border_stroke_width))
                .setCornerStrokeWidth(r.dimen(R.dimen.image_crop_view_default_corner_stroke_width))
                .setCropScale(DEFAULT_CROP_SCALE)
                .setGridStrokeWidth(r.dimen(R.dimen.image_crop_view_default_grid_stroke_width))
                .setMinWidth(r.dimen(R.dimen.image_crop_view_default_min_width))
                .setMinHeight(r.dimen(R.dimen.image_crop_view_default_min_height))
